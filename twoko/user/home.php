    ...
    <body>
        ...
        <section class="about" id="about"> 
            <div class="main">
                <img src="./assets/produk.jpeg" >
                <div class="about-text">
                    <h2>Camille</h2>
                    <p>Camille Beauty is an organic skincare and mask brand that is guaranteed to be 100% authentic, Face and Body Care for all skin types, make it yours now, you’ll be addicted babes!✨</p>
