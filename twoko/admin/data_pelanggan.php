                            ...
                            <?php
                                ...
                                while($data_register= mysqli_fetch_assoc($query_register)) { 
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="hapus_pelanggan.php?id_register=<?=$data_register['id_register']?>" onclick="return confirm ('Apakah anda yakin menghapus data ini?')" ><i class="fa-solid fa-trash"></i></a></td>
                                    </tr>
                                <?php
                                }
                                ?>
